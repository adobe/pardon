...
As a commmand-line program, `pardon` is like a dumbed-down yet easier-to-use-curl
...
This history can be searched in various ways.

## Next Steps

Now that we've gotten started, we can explore its inner workings,
